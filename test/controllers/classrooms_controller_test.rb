...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference("Classroom.count") do
      post classrooms_url, params: { classroom: { is_lab: @classroom.is_lab, room: @classroom.room, room_capacity: @classroom.room_capacity } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { is_lab: @classroom.is_lab, room: @classroom.room, room_capacity: @classroom.room_capacity } }
