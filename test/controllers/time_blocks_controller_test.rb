...
class TimeBlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_block" do
    assert_difference("TimeBlock.count") do
      post time_blocks_url, params: { time_block: { block_type: @time_block.block_type, day: @time_block.day, identifier: @time_block.identifier, timeslot: @time_block.timeslot } }
    end
  ...
  test "should update time_block" do
    patch time_block_url(@time_block), params: { time_block: { block_type: @time_block.block_type, day: @time_block.day, identifier: @time_block.identifier, timeslot: @time_block.timeslot } }
