...
rails generate scaffold Classroom room:string is_lab:integer room_capacity:integer --no-migration --force
rails generate scaffold Course name:string identifier:string needs_lab:integer course_size:integer --no-migration --force
...
rails generate scaffold TimeBlock identifier:string is_double:integer --no-migration --force
