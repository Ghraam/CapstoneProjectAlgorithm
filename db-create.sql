...
-- -----------------------------------------------------
-- Table `capstone_scheduling_project`.`assignments`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `capstone_scheduling_project`.`assignments` ;

CREATE TABLE IF NOT EXISTS `capstone_scheduling_project`.`assignments` (
  `professor_id` INT NOT NULL,
  `time_block_id` INT NOT NULL,
  `course_id` INT NOT NULL,
